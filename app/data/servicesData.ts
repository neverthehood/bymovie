export const services = [
  {
    ...
    subtitle: "Scene and scripts development, filming, post-production. All under one roof.",
    webm: "/assets/services/virtual.webm",
    mp4: "/assets/services/virtual.mp4",
  },
  {
    id: 1,
    title: "SHOOTING IN LED PAVILION",
    subtitle: "Realistic light, camera tracking, depth effect.",
    webm: "/assets/services/pavilion.webm",
    mp4: "/assets/services/pavilion.mp4",
  },
  {
    id: 2,
  ...
  },
  {
    ...
    subtitle: "If you need to bring it to perfection - we will do it.",
    webm: "/assets/services/vfx.webm",
    mp4: "/assets/services/vfx.mp4",
  },
  {
    id: 5,
